...
/// The domain for errors originating from YYModelTransformation.
extern NSString * const YYModelTransformationErrorDomain;

/// +yy_modelArrayWithClass: array: error: returned nil for the given dictionary.
extern const NSInteger YYModelTransformationErrorNoClassFound;

/// The provided JSONDictionary is not valid.
extern const NSInteger YYModelTransformationErrorInvalidJSONDictionary;

/// An exception was thrown and caught.
extern const NSInteger YYModelTransformationErrorExceptionThrown;

/// Enumeration of Conversion Types
typedef NS_ENUM(NSInteger, YYMapperType) {
    YYMapperTypeNone = 0,
    
    /** JSON key auto underscore Case To Camel Case
        Example: JSON key is "user_name", Model propertyKey is @"userName"
    */
    YYMapperTypeUnderscoreCaseToCamelCase,
};
...
/// The method Internal call + (nullable instancetype)yy_modelWithJSON:(id)json
...
+ (nullable instancetype)yy_modelWithJSON:(id)json error:(NSError **)error;
...
/// The method Internal call + (nullable instancetype)yy_modelWithDictionary:(NSDictionary *)dictionary
/// error          - If not NULL, this may be set to an error that occurs during
///                  deserializing or validation.
///
/// Returns a model object, or nil if a deserialization error occurred or the
/// model did not validate successfully.
+ (nullable instancetype)yy_modelWithDictionary:(NSDictionary *)dictionary error:(NSError **)error;
...
/// The method Internal call - (BOOL)yy_modelSetWithJSON:(id)json
/// error          - If not NULL, this may be set to an error that occurs during
///                  deserializing or validation.
...
/// The method Internal call - (BOOL)yy_modelSetWithDictionary:(NSDictionary *)dic
/// error          - If not NULL, this may be set to an error that occurs during
///                  deserializing or validation.
...
/**
 Description method for auto underscoreCase to camelCase.
...
/// The method Internal call + (nullable NSArray *)yy_modelArrayWithClass:(Class)cls json:(id)json
+ (nullable NSArray *)yy_modelArrayWithClass:(Class)cls json:(id)json error:(NSError **)error;

/**
 Creates and returns an array from a dictionary-array.
 This method is thread-safe.
 
 @param cls  The instance's class in array.
 @param arr  A dictionary array of `NSArray`.
 Example: [{@"name",@"Mary"},{@"name":@"Joe"}]
...
/// The method Internal call + (nullable NSArray *)yy_modelArrayWithClass:(Class)cls array:(NSArray *)arr
+ (nullable NSArray *)yy_modelArrayWithClass:(Class)cls array:(NSArray *)arr error:(NSError **)error;
